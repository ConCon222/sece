...
{% endif %}
  ...
  <ul class="post-list">
    ...
    {% if post.featured != true and post.featured != 'true' %}
...
{% if post.thumbnail %}
  ...
  <div class="col-sm-3">
    <img class="card-img" src="{{ post.thumbnail | relative_url }}" style="object-fit: cover; height: 90%" alt="{{ post.title | escape }}" loading="lazy">
  </div>
</div>
{% endif %}
    </li>
